...
<nav class="navbar navbar-inverse">
  <div class="container">
    ...
    <ul class="nav navbar-nav navbar-right">
      <li><a href="http://localhost/university/public/"><span class="glyphicon glyphicon-user"></span> Sign Up</a></li>
...
<div class="container">
  ...
  <form class="form-horizontal" action="{{ url('/details_save') }}" method="post">
    {{csrf_field()}}
    ...
    <div class="form-group">
      <label class="control-label col-sm-2" for="email">Mobile &nbsp;<span class="asterik">*</span>:</label>
      <div class="col-sm-4">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="text" class="form-control" id="alt_moile" placeholder="Enter alternate mobile" name="alt_mobile">
      </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <div class="col-sm-4">
        <input type="email" class="form-control" id="email" placeholder="Enter altrnate  email " name="alt_email">
      </div>
    </div>
    ...
    <div class="form-group">
      <label class="control-label col-sm-2">Address &nbsp;<span class="asterik">*</span>:</label>
      <div class="col-sm-4">
        <textarea class="form-control" rows="5" name="address"></textarea>
    </div>
  </div>
  <div class="form-group">
      <label class="control-label col-sm-2">Course &nbsp;<span class="asterik">*</span>:</label>
      <div class="col-sm-4">
        ...
        <option>DIPLOMA</option>
          ...
          <div class="form-group">
      <label class="control-label col-sm-2">Country &nbsp;<span class="asterik">*</span>:</label>
      <div class="col-sm-4">
  ...
  <div class="form-group">
    ...
    <div class="form-group">        
      <div class="col-sm-offset-2 col-sm-10">
        <button type="submit" class="btn btn-default">Save & poceed</button>
      </div>
    </div> 
  </form>
</div>
